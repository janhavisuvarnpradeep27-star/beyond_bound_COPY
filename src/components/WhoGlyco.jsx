	...
	},
	{
		...
		icon: (
			<svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				<circle cx="10" cy="7" r="4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
				<path d="M3 20C3 17.2386 5.23858 15 8 15H12C14.7614 15 17 17.2386 17 20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
				<path d="M17 7C17 7 18 7 18 9C18 11 17 11 17 11" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
				<path d="M19 15C20.1046 15 21 15.8954 21 17V20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
			</svg>
		),
	},
	{
		...
		icon: (
			<svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<path d="M12 21C12 17 12 14 14.5 10.5C16.5 7.5 19 6 19 6C19 6 17.5 8.5 14.5 11.5C12.5 13.5 12 16 12 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
				<path d="M12 16C12 16 9.5 16.5 6.5 14.5C4 13 3 10 3 10C3 10 5.5 10 8.5 12C11.5 14 12 16 12 16" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
			</svg>
		),
	},
]
